...
For each model: Include one map and distribution histogram from the test results for t+1 00 UTC in both dpm (direct prediciton) and rcm (residual correction), being our first timestep forecast, 12 hours after the initialization date.
